 ...
 * @returns
 */
export const getMySeeingCollection = (
  uid: number,
  cat?: ['watching', 'all_watching'],
  responseGroup?: ['medium', 'small']
) => {
  return bangumiRequest({
    method: 'get',
 ...
 * @returns
 */
export const getUserCollectionByType = (
  uid: number,
  type?: number,
  limit?: number,
  offset?: number,
 ...
 * @returns
 */
export const changeCollectionStatus = (
  subjectId: number,
